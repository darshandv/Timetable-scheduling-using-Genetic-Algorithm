...
public class Initialization {
	...
	private int min;
	String csvFile = "/home/darshan/CS/SE/research/Timetable-Generator-using-Genetic-Algorithm-master/src/dynamicTT/Classroom.csv";
...
//			classroom.add(room1);
			...
			String csvFile = "/home/darshan/CS/SE/research/Timetable-Generator-using-Genetic-Algorithm-master/src/dynamicTT/Professors.csv";
		    BufferedReader br = null;
		    String line = "";
		    br = new BufferedReader(new FileReader(csvFile));
			while ((line = br.readLine()) != null) {
